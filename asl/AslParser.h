...
public:
  enum {
    ...
    T__7 = 8, ASSIGN = 9, EQUAL = 10, NEQ = 11, LET = 12, LEQ = 13, GET = 14, 
    GEQ = 15, NOT = 16, AND = 17, OR = 18, PLUS = 19, MINUS = 20, MUL = 21, 
    DIV = 22, MOD = 23, VAR = 24, INT = 25, FLOAT = 26, CHAR = 27, BOOL = 28, 
    ARRAY = 29, IF = 30, THEN = 31, ELSE = 32, ENDIF = 33, WHILE = 34, DO = 35, 
    ENDWHILE = 36, FUNC = 37, ENDFUNC = 38, RETURN = 39, READ = 40, WRITE = 41, 
    BOOLVAL = 42, ID = 43, INTVAL = 44, FLOATNUM = 45, CHAREXPR = 46, STRING = 47, 
    COMMENT = 48, WS = 49
  };
